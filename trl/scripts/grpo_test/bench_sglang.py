...
def get_few_shot_examples(lines, k):
    return "\n\n".join([get_one_example(lines, i, True) for i in range(k)]) + "\n\n"
...
def main(args):
    ...
    questions = [get_one_example(lines, i, False) for i in range(args.num_questions)]
    labels = [get_answer_value(lines[i]["answer"]) for i in range(args.num_questions)]
